...
namespace Tygh\Addons\Queue\CronExpressionParser;
...
class Validator
{
    ...
    /**
     * Check if the value falls between start and end when advanced by step.
     *
     * @param int $value
     * @param int $start
     * @param int $end
     ...
     *
     * @param string                                 $value
     * @param \Tygh\Addons\Cron\Parser\ReferenceTime $reference
     *
     * @return bool
     * @internal
     *
